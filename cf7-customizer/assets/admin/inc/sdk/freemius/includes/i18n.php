<?php
	...
	$fs_text = array(
		...
		'connect-message'                          => __( "</br>Allow us to connect %s with %s. </br></br>  Customize your contact forms and help us track the bugs(if-any), provide support and improve your experience.", 'freemius' ),
		...
		'opt-in-connect-started'                   => _x( 'Connect & Get Started', 'button label', 'freemius' ),
